...
public class BMWFour extends BMW implements Runnable {
	private String ID, PS, color, extras, extras1, tires;
	private String BMW4 = "BMW4";
	private int price = 27250;
	private Chassis ch;
	private BodyShop bs;
	...
	public BMWFour(Chassis ch, BodyShop bs, ComponentInstallation ci, VehicleAssembly va, QualityControl qc) {
		this.ch = ch;
		this.bs = bs;
		this.ci = ci;
		this.va = va;
	...
	public String getBMW4() {
		return BMW4;
	}

	public void setBMW1(String BMW4) {
		this.BMW4 = BMW4;
	}
